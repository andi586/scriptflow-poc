...
export default function CreatePage() {
  ...
  return (
    <div style={{background:'#0a0a0a',minHeight:'100vh',color:'white',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'40px 20px',fontFamily:'system-ui'}}>
      ...
      <label style={{cursor:'pointer',marginBottom:'32px'}}>
        {photoUrl
      ...
      {loading && <p style={{color:'#888',marginTop:'24px',textAlign:'center'}}>Your movie is being created.<br/>This takes 2-5 minutes...</p>}
    </div>
  )
}
