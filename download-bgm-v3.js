...
// Using working Pixabay CDN URLs (these are confirmed working)
const tracks = [
  { 
    name: 'phone_3am',
    url: 'https://cdn.pixabay.com/download/audio/2022/03/10/audio_4037f4e1e5.mp3',
  ...
  { 
    ...
    url: 'https://cdn.pixabay.com/download/audio/2022/08/02/audio_4e5a0e1c8e.mp3',
    description: 'Nostalgic piano melody'
  },
  { 
    name: 'group_chat',
    url: 'https://cdn.pixabay.com/download/audio/2022/03/15/audio_c8a5d2e8e5.mp3',
    description: 'Cold digital atmosphere'
  },
  { 
    name: 'dog_last_words',
    url: 'https://cdn.pixabay.com/download/audio/2022/10/27/audio_9b5156c3e0.mp3',
    description: 'Emotional sad piano'
  },
  { 
    name: 'breaking_news',
    url: 'https://cdn.pixabay.com/download/audio/2022/03/24/audio_c8c5d5e0e3.mp3',
    description: 'News broadcast dramatic'
  }
];

// Helper function to download file with proper headers
